...
module.exports = {
    ...
    categories : 'games', 
    permissions : ' ', 
    description: 'Joginho deo 4 em linha',
    usage: '',
    /** 
     * @param {Client} client 
    ...
    run: async(client, message, args) => {
        ...
        if (reaction.emoji.name === "❌") {
            ...
            question.edit("Looks like they didn't want to play");
            return
        } else {
            ...
            gameCollector.on("collect", (reaction, user) => {
                ...
                if (user.id === gameData[player].member.id) {
                    ...
                    if (tieCheck()) {
                        ...
                        //gameMessage.edit(`It was a tie game!`, { embeds: [TieEmbed] });
                        gameMessage.edit({ embeds: [TieEmbed] });
                        return message.channel.send(`It was a tie game!`)
                    ...
                    for (const func of checks) {
                        ...
                        if (data) {
                            ...
                            //gameMessage.edit(`${gameData[player].member} has won the game!`, { embeds: [WinEmbed] });
                            gameMessage.edit({ embeds: [WinEmbed] });
                            return message.channel.send(`${gameData[player].member} has won the game!`)
